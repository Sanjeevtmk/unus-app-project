...
import com.example.madproject.AppController;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static String URL_REGISTER="https://sanjeevtmk.000webhostapp.com/StudentRegister/register.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                String roll_no = inputroll.getText().toString().trim();
     ...
     * */
    private void registerUser(final String name,final String roll_no, final String email,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(name,roll_no, email, uid, created_at);
